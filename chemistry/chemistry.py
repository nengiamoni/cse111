...
def get_formula_name(formula, known_molecules_dict):
    if formula in known_molecules_dict:
        return [True, known_molecules_dict[formula]]
    else:
        return [False, ""]
...
def main():
    ...
    print(
        f"The number of moles in {mass} grams of {formula} is {number_of_moles:.5f} moles.")

    # Print the name of the compound conditionally.
    if compound_name[0] == True:
        print(
            f"The name of the chemical formula {formula} is {compound_name[1]}.")
